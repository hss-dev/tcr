...
export interface ITcrTabRemoveState extends ITeamsBaseComponentState {
    value: string;
}
export interface ITcrTabRemoveProps {

}

/**
 * Implementation of tcr Tab remove page
 */
export class TcrTabRemove  extends TeamsBaseComponent<ITcrTabRemoveProps, ITcrTabRemoveState> {
